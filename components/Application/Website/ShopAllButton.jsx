...
const ShopAllButton = ({
    ...
    return (
        <button
            ...
            className={cn(
                "group relative inline-flex h-12 min-w-[220px] cursor-pointer select-none items-center justify-center overflow-hidden border px-10 text-[0.78rem] font-semibold uppercase transition-colors duration-200",
                radiusClass,
                className
            )}
