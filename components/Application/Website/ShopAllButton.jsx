...
const ShopAllButton = ({
    ...
    const sharedClassName = cn(
        "group relative inline-flex h-12 w-full min-w-0 cursor-pointer select-none items-center justify-center overflow-hidden border px-6 cta-text-caps font-semibold uppercase transition-colors duration-200 sm:w-auto sm:min-w-[220px] sm:px-10",
        radiusClass,
        className
    )
    const sharedProps = {
