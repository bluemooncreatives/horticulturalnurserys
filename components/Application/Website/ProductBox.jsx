    ...
    return (
        <div className='group relative flex flex-col overflow-hidden rounded-[var(--radius-3xl)] border border-border bg-white transition duration-300 hover:-translate-y-0.5 hover:border-foreground/25 hover:shadow-[var(--shadow-card-hover)]'>
            <div className="relative aspect-[4/5] w-full overflow-hidden bg-[var(--product-card-bg)]">
                ...
                <div className="absolute left-3 top-3 z-20 flex flex-col items-start gap-1.5">
                    {product?.isBestseller && (
                        <span className="inline-flex items-center gap-1 rounded-full bg-[var(--brand-primary)] px-2.5 py-1 text-[0.8rem] font-semibold uppercase text-white shadow-sm">
                            <Crown className="size-3" />
                            Best Seller
                        </span>
                    )}
                    {product?.isFreshlyArrived && (
                        <span className="inline-flex items-center gap-1 rounded-full bg-[var(--brand-lime)] px-2.5 py-1 text-[0.8rem] font-semibold uppercase text-[var(--brand-lime-ink)] shadow-sm">
            ...
            >
                ...
                <span className="shrink-0 text-[0.8rem] font-semibold uppercase text-[var(--brand-primary)] sm:text-[0.8rem]">
                    On Enquiry
                </span>
            </Link>
        </div>
