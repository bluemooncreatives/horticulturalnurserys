                        ...
                        <Form {...form}>
                            <form id="enquiry-form" onSubmit={form.handleSubmit(submitEnquiry)}>
                                ...
                                <div className="mb-5 flex items-center gap-2">
                                    ...
                                    <h2 className="font-neue text-base font-semibold uppercase">Your Contact Details</h2>
                                </div>
                                ...
                                <div className="mb-5 mt-10 flex items-center gap-2">
                                    ...
                                    <h2 className="font-neue text-base font-semibold uppercase">Delivery Location <span className="ml-1 text-[0.8rem] font-medium normal-case tracking-normal text-muted-foreground">(optional)</span></h2>
                                </div>
                        ...
                        <div className="space-y-4 lg:sticky lg:top-24">
                            <div className="overflow-hidden rounded-md border border-border/60 bg-background shadow-sm">
                                <div className="flex items-center justify-between border-b border-border/60 px-5 py-4">
                                    ...
                                    <span className="rounded-full bg-muted/60 px-2.5 py-0.5 text-[0.8rem] font-medium uppercase text-muted-foreground">
                                        ...
                                        <div key={product.variantId} className="flex gap-3 py-4">
                                            ...
                                            <div className="flex min-w-0 flex-1 flex-col">
                                                ...
                                                {(product.size || product.color) && (
                                                    <span className="mt-1 w-fit rounded-full bg-muted/60 px-2 py-0.5 text-[0.8rem] font-medium uppercase text-muted-foreground">
                                                ...
                                                <div className="mt-auto flex items-center justify-between pt-2.5">
                                                    ...
                                                    <span className="text-[0.8rem] font-medium uppercase text-muted-foreground">Price on enquiry</span>
                                                </div>
                                            </div>
                                        </div>
                                    ))}
